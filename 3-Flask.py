...
# D:\Udemy\Complete_GenAI_Langchain_Huggingface\UPractice2\GenAI Language Translator>python 3-Flask.py
...
def welcome():
    ...
    return render_template("front_page2.html", final_text=final_text, languages = languages)
